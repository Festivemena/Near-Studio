...
exports.VisualDesignProvider = void 0;
// src/providers/VisualDesignerProvider.ts
const vscode = __importStar(require("vscode"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const build_system_1 = require("../build-system");
class VisualDesignProvider {
    postMessage(message) {
    ...
    constructor(_extensionUri) {
        ...
        this.buildSystem = new build_system_1.NearBuildSystem();
    }
    ...
    async generateContractCode(components, language) {
        try {
            let code = '';
            switch (language) {
                case 'rust':
    ...
    generateRustContract(components) {
        const stateVars = [];
        const functions = [];
...
mod tests {
    ...
    generateJSContract(components, isTypeScript) {
        const stateVars = [];
        const functions = [];
...
${functions.join('\n\n')}
    ...
    generateRustPayableMethod(props) {
        const returnType = props.returnType || 'String';
        return `    #[payable]
    ...
    generateJSViewMethod(props, isTypeScript) {
    ...
    generateJSCallMethod(props, isTypeScript) {
        const params = props.parameters || '';
        const paramType = isTypeScript && params ? `: { ${params} }` : '';
        return `    @call({})
    ...
    generateJSPayableMethod(props, isTypeScript) {
    ...
    jsTypeMapping(rustType) {
        switch (rustType) {
            case 'String': return 'string';
            case 'AccountId': return 'string';
            case 'u64':
            case 'u128': return 'string'; // NEAR uses string for big numbers
    ...
    async buildGeneratedContract(components, language) {
        const workspaceFolder = vscode.workspace.workspaceFolders?.[0];
        if (!workspaceFolder) {
            vscode.window.showErrorMessage('No workspace folder found');
            return;
    ...
    async deployGeneratedContract(components, language) {
...
exports.VisualDesignProvider = VisualDesignProvider;
VisualDesignProvider.viewType = 'near-studio.visualDesigner';
=======
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
...
exports.VisualDesignProvider = VisualDesignProvider;
VisualDesignProvider.viewType = 'near-studio.visualDesigner';
>>>>>>> 439609b929abc7777f8d9dab4458aaabfaecaac2
//# sourceMappingURL=VisualDesignProvider.js.map