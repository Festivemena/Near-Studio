...
export class NearBuildSystem {
    ...
    async buildContract(config: BuildConfig): Promise<boolean> {
    ...
    private async buildRustContract(config: BuildConfig): Promise<boolean> {
    ...
    private async buildJSContract(config: BuildConfig): Promise<boolean> {
        const { projectPath, contractName, outputPath, optimization } = config;
    ...
    private async optimizeWasm(wasmPath: string): Promise<void> {
        try {
    ...
    async runTests(config: BuildConfig): Promise<boolean> {
        this.outputChannel.clear();
        this.outputChannel.show();
    ...
    async deployContract(config: BuildConfig, accountId: string, network: string): Promise<boolean> {
        this.outputChannel.clear();
        this.outputChannel.show();
    ...
    async generateBindings(config: BuildConfig, outputDir: string): Promise<void> {
    ...
    private async generateTypeScriptBindings(config: BuildConfig, outputDir: string): Promise<void> {
...
`;
    ...
    private async generateJavaScriptHelpers(config: BuildConfig, outputDir: string): Promise<void> {
